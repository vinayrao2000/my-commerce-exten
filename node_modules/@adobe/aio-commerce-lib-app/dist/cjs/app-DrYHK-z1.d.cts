 ...
 */
declare function getConfigDomains(config: AnyCommerceAppConfig): Set<CommerceAppConfigDomain>;
/**
 * Check if the config has a specific domain.
 * @param config - The configuration to check.
 * @param domain - The domain to check.
 */
declare function hasConfigDomain(config: AnyCommerceAppConfig, domain: CommerceAppConfigDomain): boolean;
//#endregion
...
//#endregion
export { CommerceAppConfigSchemas as a, CommerceAppConfigDomain as i, CommerceAppConfig as n, getConfigDomains as o, CommerceAppConfigOutputModel as r, hasConfigDomain as s, AnyCommerceAppConfig as t };