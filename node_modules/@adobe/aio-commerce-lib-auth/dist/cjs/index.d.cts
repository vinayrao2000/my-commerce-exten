...
declare const ImsAuthEnvSchema: import("valibot").PicklistSchema<["prod", "stage"], undefined>;
/** Defines the schema to validate the necessary parameters for the IMS auth service. */
declare const ImsAuthParamsSchema: import("valibot").ObjectSchema<{
  readonly clientId: import("valibot").SchemaWithPipe<readonly [import("valibot").StringSchema<`Expected a string value for the IMS auth parameter ${string}`>, import("valibot").NonEmptyAction<string, `Expected a non-empty string value for the IMS auth parameter ${string}`>]>;
  readonly clientSecrets: import("valibot").SchemaWithPipe<readonly [import("valibot").ArraySchema<import("valibot").StringSchema<undefined>, `Expected a string array value for the IMS auth parameter ${string}`>, import("valibot").MinLengthAction<string[], number, `Expected at least ${number} items for the IMS auth parameter ${string}`>]>;
  readonly technicalAccountId: import("valibot").SchemaWithPipe<readonly [import("valibot").StringSchema<`Expected a string value for the IMS auth parameter ${string}`>, import("valibot").NonEmptyAction<string, `Expected a non-empty string value for the IMS auth parameter ${string}`>]>;
  readonly technicalAccountEmail: import("valibot").SchemaWithPipe<readonly [import("valibot").StringSchema<"Expected a string value for the IMS auth parameter technicalAccountEmail">, import("valibot").EmailAction<string, "Expected a valid email format for technicalAccountEmail">]>;
  readonly imsOrgId: import("valibot").SchemaWithPipe<readonly [import("valibot").StringSchema<`Expected a string value for the IMS auth parameter ${string}`>, import("valibot").NonEmptyAction<string, `Expected a non-empty string value for the IMS auth parameter ${string}`>]>;
  readonly environment: import("valibot").SchemaWithPipe<readonly [import("valibot").OptionalSchema<import("valibot").PicklistSchema<["prod", "stage"], undefined>, undefined>]>;
  readonly context: import("valibot").SchemaWithPipe<readonly [import("valibot").OptionalSchema<import("valibot").StringSchema<undefined>, undefined>]>;
  readonly scopes: import("valibot").SchemaWithPipe<readonly [import("valibot").ArraySchema<import("valibot").StringSchema<undefined>, `Expected a string array value for the IMS auth parameter ${string}`>, import("valibot").MinLengthAction<string[], number, `Expected at least ${number} items for the IMS auth parameter ${string}`>]>;
}, undefined>;
 ...
 */
declare const IntegrationAuthParamsSchema: import("valibot").NonOptionalSchema<import("valibot").ObjectSchema<{
  readonly consumerKey: import("valibot").SchemaWithPipe<readonly [import("valibot").StringSchema<`Expected a string value for the Commerce Integration parameter ${string}`>, import("valibot").NonEmptyAction<string, `Expected a non-empty string value for the Commerce Integration parameter ${string}`>]>;
  readonly consumerSecret: import("valibot").SchemaWithPipe<readonly [import("valibot").StringSchema<`Expected a string value for the Commerce Integration parameter ${string}`>, import("valibot").NonEmptyAction<string, `Expected a non-empty string value for the Commerce Integration parameter ${string}`>]>;
  readonly accessToken: import("valibot").SchemaWithPipe<readonly [import("valibot").StringSchema<`Expected a string value for the Commerce Integration parameter ${string}`>, import("valibot").NonEmptyAction<string, `Expected a non-empty string value for the Commerce Integration parameter ${string}`>]>;
  readonly accessTokenSecret: import("valibot").SchemaWithPipe<readonly [import("valibot").StringSchema<`Expected a string value for the Commerce Integration parameter ${string}`>, import("valibot").NonEmptyAction<string, `Expected a non-empty string value for the Commerce Integration parameter ${string}`>]>;
}, undefined>, undefined>;
