 ...
 * @template THeaders - Custom response headers
 */
type ActionResponse<TSuccessBody extends BodyRecord = BodyRecord, TErrorBody extends BodyRecordWithMessage = BodyRecordWithMessage, THeaders extends HeadersRecord = HeadersRecord> = SuccessResponse<TSuccessBody, THeaders> | ErrorResponse<TErrorBody, THeaders>;
/**
 ...
 * See {@link buildSuccessResponse} for details on the response payload.
 */
declare const accepted: (payload?: string | {
  body?: BodyRecord;
  headers?: HeadersRecord;
}) => SuccessResponse<BodyRecord, HeadersRecord>;
/**
 ...
 */
declare const noContent: () => SuccessResponse<BodyRecord, HeadersRecord>;
/**
 ...
 * See {@link buildErrorResponse} for details on the response payload.
 */
declare const methodNotAllowed: (payload: string | {
  body: BodyRecordWithMessage;
  headers?: HeadersRecord;
}) => ErrorResponse<BodyRecordWithMessage, HeadersRecord>;
/**
 ...
 * See {@link buildErrorResponse} for details on the response payload.
 */
declare const conflict: (payload: string | {
  body: BodyRecordWithMessage;
  headers?: HeadersRecord;
}) => ErrorResponse<BodyRecordWithMessage, HeadersRecord>;
/**
...
//#endregion
export { type ActionResponse, type ErrorResponse, HTTP_ACCEPTED, HTTP_BAD_REQUEST, HTTP_CONFLICT, HTTP_CREATED, HTTP_FORBIDDEN, HTTP_INTERNAL_SERVER_ERROR, HTTP_METHOD_NOT_ALLOWED, HTTP_NON_AUTHORITATIVE_INFORMATION, HTTP_NOT_FOUND, HTTP_NO_CONTENT, HTTP_OK, HTTP_UNAUTHORIZED, type SuccessResponse, accepted, badRequest, buildErrorResponse, buildSuccessResponse, conflict, created, forbidden, internalServerError, methodNotAllowed, noContent, nonAuthoritativeInformation, notFound, ok, unauthorized };