...
declare const CreateEventMetadataForProviderSchema: v.ObjectSchema<{
  ...
  readonly sampleEventTemplate: v.OptionalSchema<v.SchemaWithPipe<readonly [v.UnionSchema<[v.SchemaWithPipe<readonly [v.StringSchema<`Expected a string value for '${string}'`>, v.TransformAction<string, string>, v.ParseJsonAction<string, undefined, `Expected valid JSON string for property '${string}'`>, v.RecordSchema<v.StringSchema<undefined>, v.UnknownSchema, undefined>]>, v.RecordSchema<v.StringSchema<undefined>, v.UnknownSchema, undefined>, v.ArraySchema<v.UnknownSchema, undefined>], undefined>, v.StringifyJsonAction<{
    [x: string]: unknown;
  } | unknown[], undefined, `Expected valid JSON data for property '${string}'`>, v.TransformAction<string, string>]>, undefined>;
}, undefined>;
/**
 * The schema of the parameters received by the GET `providers/:id/eventmetadata` Adobe I/O Events API endpoint.
 * @see https://developer.adobe.com/events/docs/api#operation/getByProviderId
 */
type GetAllEventMetadataForProviderParams = v.InferInput<typeof GetAllEventMetadataForProviderSchema>;
/**
 * The schema of the parameters received by the GET `providers/:id/eventmetadata/:code` Adobe I/O Events API endpoint.
 * @see https://developer.adobe.com/events/docs/api#operation/getByProviderIdAndEventCode
 */
type GetEventMetadataForEventAndProviderParams = v.InferInput<typeof GetEventMetadataForEventAndProviderSchema>;
/** The schema of the parameters received by the DELETE `providers/:id/eventmetadata/:code` Adobe I/O Events API endpoint. */
declare const DeleteEventMetadataForProviderSchema: v.ObjectSchema<{
  readonly consumerOrgId: v.StringSchema<`Expected a string value for '${string}'`>;
  readonly projectId: v.StringSchema<`Expected a string value for '${string}'`>;
  readonly workspaceId: v.StringSchema<`Expected a string value for '${string}'`>;
  readonly providerId: v.StringSchema<`Expected a string value for '${string}'`>;
 ...
 */
type CreateEventMetadataForProviderParams = v.InferInput<typeof CreateEventMetadataForProviderSchema>;
/**
 * The schema of the parameters received by the DELETE `providers/:id/eventmetadata/:code` Adobe I/O Events API endpoint.
 * @see https://developer.adobe.com/events/docs/api#operation/deleteEventMetadata
 */
type DeleteEventMetadataForProviderParams = v.InferInput<typeof DeleteEventMetadataForProviderSchema>;
//#endregion
//#region source/io-events/api/event-metadata/endpoints.d.ts
/**
 ...
 * @throws An {@link HTTPError} If the status code is not 2XX.
 */
declare function deleteEventMetadataForProvider(httpClient: AdobeIoEventsHttpClient, params: DeleteEventMetadataForProviderParams, fetchOptions?: Options): Promise<void>;
//#endregion
 ...
 */
type EventProviderListAllParams = v.InferInput<typeof EventProviderListAllParamsSchema>;
/**
...
declare const EventProviderDeleteParamsSchema: v.ObjectSchema<{
  readonly consumerOrgId: v.StringSchema<`Expected a string value for '${string}'`>;
  readonly projectId: v.StringSchema<`Expected a string value for '${string}'`>;
  readonly workspaceId: v.StringSchema<`Expected a string value for '${string}'`>;
  readonly providerId: v.StringSchema<`Expected a string value for '${string}'`>;
 ...
 */
type EventProviderDeleteParams = v.InferInput<typeof EventProviderDeleteParamsSchema>;
//#endregion
//#region source/io-events/api/event-providers/endpoints.d.ts
/**
 ...
 * @throws An {@link HTTPError} If the status code is not 2XX.
 */
declare function deleteEventProvider(httpClient: AdobeIoEventsHttpClient, params: EventProviderDeleteParams, fetchOptions?: Options): Promise<void>;
//#endregion
 ...
 */
declare function createAdobeIoEventsApiClient(params: IoEventsHttpClientParams): import("@adobe/aio-commerce-lib-api").ApiClientRecord<AdobeIoEventsHttpClient, {
  getAllRegistrationsByConsumerOrg(httpClient: AdobeIoEventsHttpClient, params: GetAllRegistrationsByConsumerOrgParams, fetchOptions?: import("ky").Options): Promise<IoEventRegistrationPaginatedResponse>;
  getAllRegistrations(httpClient: AdobeIoEventsHttpClient, params: GetAllRegistrationsParams, fetchOptions?: import("ky").Options): Promise<IoEventRegistrationManyResponse>;
  getRegistrationById(httpClient: AdobeIoEventsHttpClient, params: GetRegistrationByIdParams, fetchOptions?: import("ky").Options): Promise<IoEventRegistrationHalModel>;
  createRegistration(httpClient: AdobeIoEventsHttpClient, params: CreateRegistrationParams, fetchOptions?: import("ky").Options): Promise<IoEventRegistrationHalModel>;
  updateRegistration(httpClient: AdobeIoEventsHttpClient, params: UpdateRegistrationParams, fetchOptions?: import("ky").Options): Promise<IoEventRegistrationHalModel>;
  deleteRegistration(httpClient: AdobeIoEventsHttpClient, params: DeleteRegistrationParams, fetchOptions?: import("ky").Options): Promise<void>;
  getAllCommerceEventProviders(httpClient: AdobeIoEventsHttpClient, params: import("type-fest").OmitDeep<EventProviderListAllParams, "filterBy.providerType">, fetchOptions?: import("ky").Options): Promise<IoEventProviderManyResponse>;
  getAll3rdPartyCustomEventProviders(httpClient: AdobeIoEventsHttpClient, params: import("type-fest").OmitDeep<EventProviderListAllParams, "filterBy.providerType">, fetchOptions?: import("ky").Options): Promise<IoEventProviderManyResponse>;
  createCommerceEventProvider(httpClient: AdobeIoEventsHttpClient, params: import("type-fest").OmitDeep<EventProviderCreateParams, "providerType">, fetchOptions?: import("ky").Options): Promise<IoEventProviderHalModel>;
  create3rdPartyCustomEventProvider(httpClient: AdobeIoEventsHttpClient, params: import("type-fest").OmitDeep<EventProviderCreateParams, "providerType">, fetchOptions?: import("ky").Options): Promise<IoEventProviderHalModel>;
  getAllEventMetadataForProvider(httpClient: AdobeIoEventsHttpClient, params: GetAllEventMetadataForProviderParams, fetchOptions?: import("ky").Options): Promise<IoEventMetadataManyResponse>;
  getEventMetadataForEventAndProvider(httpClient: AdobeIoEventsHttpClient, params: GetEventMetadataForEventAndProviderParams, fetchOptions?: import("ky").Options): Promise<IoEventMetadataHalModel>;
  createEventMetadataForProvider(httpClient: AdobeIoEventsHttpClient, params: CreateEventMetadataForProviderParams, fetchOptions?: import("ky").Options): Promise<IoEventMetadataHalModel>;
  deleteEventMetadataForProvider(httpClient: AdobeIoEventsHttpClient, params: DeleteEventMetadataForProviderParams, fetchOptions?: import("ky").Options): Promise<void>;
  getAllEventProviders(httpClient: AdobeIoEventsHttpClient, params: EventProviderListAllParams, fetchOptions?: import("ky").Options): Promise<IoEventProviderManyResponse>;
  getEventProviderById(httpClient: AdobeIoEventsHttpClient, params: EventProviderGetByIdParams, fetchOptions?: import("ky").Options): Promise<IoEventProviderHalModel>;
  createEventProvider(httpClient: AdobeIoEventsHttpClient, params: EventProviderCreateParams, fetchOptions?: import("ky").Options): Promise<IoEventProviderHalModel>;
  deleteEventProvider(httpClient: AdobeIoEventsHttpClient, params: EventProviderDeleteParams, fetchOptions?: import("ky").Options): Promise<void>;
}>;
/**
 ...
 */
declare function createCustomAdobeIoEventsApiClient<TFunctions extends Record<string, ApiFunction<AdobeIoEventsHttpClient, any[], any>>>(params: IoEventsHttpClientParams, functions: TFunctions): import("@adobe/aio-commerce-lib-api").ApiClientRecord<AdobeIoEventsHttpClient, TFunctions>;
//#endregion
...
//#endregion
export { AdobeIoEventsApiClient, type CreateEventMetadataForProviderParams, type CreateEventMetadataForProviderSchema, type CreateRegistrationParams, type CreateRegistrationParamsSchema, type DataResidencyRegion, type DataResidencyRegionSchema, type DeleteEventMetadataForProviderParams, type DeleteEventMetadataForProviderSchema, type DeleteRegistrationParams, type DeleteRegistrationParamsSchema, type DeliveryType, type DeliveryTypeSchema, type DestinationMetadataSchema, type EventProviderCreateParams, type EventProviderCreateParamsSchema, type EventProviderDeleteParams, type EventProviderDeleteParamsSchema, type EventProviderGetByIdParams, type EventProviderGetByIdParamsSchema, type EventProviderListAllParams, type EventProviderListAllParamsSchema, type EventProviderType, type EventProviderTypeSchema, type EventsOfInterestSchema, type GetAllEventMetadataForProviderParams, type GetAllEventMetadataForProviderSchema, type GetAllRegistrationsByConsumerOrgParams, type GetAllRegistrationsByConsumerOrgParamsSchema, type GetAllRegistrationsParams, type GetAllRegistrationsParamsSchema, type GetEventMetadataForEventAndProviderParams, type GetEventMetadataForEventAndProviderSchema, type GetRegistrationByIdParams, type GetRegistrationByIdParamsSchema, type IoEventMetadata, type IoEventMetadataManyResponse, type IoEventMetadataOneResponse, type IoEventProvider, type IoEventProviderManyResponse, type IoEventProviderOneResponse, type IoEventRegistration, type IoEventRegistrationManyResponse, type IoEventRegistrationOneResponse, type IoEventRegistrationPaginatedResponse, type PageMetadata, type SubscriberFilter, type SubscriberFilterModel, type SubscriberFilterSchema, type UpdateRegistrationParams, type UpdateRegistrationParamsSchema, create3rdPartyCustomEventProvider, createAdobeIoEventsApiClient, createCommerceEventProvider, createCustomAdobeIoEventsApiClient, createEventMetadataForProvider, createEventProvider, createRegistration, deleteEventMetadataForProvider, deleteEventProvider, deleteRegistration, getAll3rdPartyCustomEventProviders, getAllCommerceEventProviders, getAllEventMetadataForProvider, getAllEventProviders, getAllRegistrations, getAllRegistrationsByConsumerOrg, getEventMetadataForEventAndProvider, getEventProviderById, getRegistrationById, updateRegistration };